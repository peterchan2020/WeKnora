...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    chunking: {
      ...
      childChunkSizeDescription: 'Размер встроенного блока для векторного матчинга (64–2048). По умолчанию 768 ≈ 160 токенов — оптимум для эмбеддеров уровня sentence-transformer / BGE.',
      ...
      strategies: {
        ...
        semantic: {
          label: 'Семантическое',
          tooltip: 'Встраивает окна предложений и разбивает текст в местах сильного смыслового сдвига; если эмбеддинги недоступны, автоматически возвращается к разбиению по длине.'
        }
      },
      ...
      semanticBufferSizeLabel: 'Размер семантического буфера',
      semanticBufferSizeDescription: 'Радиус окна предложений перед эмбеддингом. По умолчанию 1, как в LlamaIndex; 0 сравнивает отдельные предложения.',
      semanticBreakpointPercentileLabel: 'Процентиль семантического разрыва',
      semanticBreakpointPercentileDescription: 'Разбивает там, где расстояние между соседними окнами предложений выше этого процентиля. Чем выше значение, тем меньше и крупнее семантические блоки.',
      languageOptions: {
        de: 'Немецкий',
        en: 'Английский',
        zh: 'Китайский'
